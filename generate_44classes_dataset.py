...
extracted_nonGNRA_pdb_folders_path_list = os.listdir(sys.argv[1])
# print(extracted_nonGNRA_pdb_folders_path_list)

for folder in extracted_nonGNRA_pdb_folders_path_list:  # folder = cluster name
    # print(folder)
    # print(folder[2:])
